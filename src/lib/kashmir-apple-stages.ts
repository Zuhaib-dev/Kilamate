...
export const KASHMIR_APPLE_STAGES: PhenologicalStage[] = [
  ...
  },
  {
    ...
    emoji: "🍏",
    months: [4, 5],
    monthLabel: "Late April - Early May",
    beeFriendly: true,
    accent: "#84cc16",
    fertilizer: ["X"],
    practices: [
  ...
  },
  {
    ...
    emoji: "🍎",
    months: [5, 6],
    monthLabel: "Late May - Early June",
    beeFriendly: true,
    accent: "#e11d48",
