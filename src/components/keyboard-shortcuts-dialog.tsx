...
export function KeyboardShortcutsDialog({
    ...
    const shortcuts = [
        ...
        { keys: ["Ctrl", "R"], description: "Refresh weather data" },
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                ...
                <div className="text-xs text-muted-foreground mt-4">
                    <p>💡 Tip: Press <kbd className="px-1 py-0.5 text-xs bg-gray-100 dark:bg-gray-600 rounded">Shift</kbd> + <kbd className="px-1 py-0.5 text-xs bg-gray-100 dark:bg-gray-600 rounded">?</kbd> anytime to see this help</p>
                </div>
            </DialogContent>
        </Dialog>
    );
