  ...
  return (
    <Card className="h-full">
      ...
      <CardContent>
          ...
          {nextDays.map((day) => {
            ...
            return (
              ...
              >
                ...
                {/* Temperature range bar — animated fill */}
                <div className="relative h-1.5 rounded-full bg-muted overflow-hidden mx-1">
                  <motion.div
                    ...
                    initial={{ width: 0, left: `${barLeft}%` }}
                    whileInView={{ width: `${barWidth}%`, left: `${barLeft}%` }}
                    viewport={{ once: true }}
        ...
        {/* Avg wind */}
        <motion.div
          className="flex items-center gap-1.5 mt-3 pt-2.5 border-t text-xs text-muted-foreground"
          initial={{ opacity: 0 }}
