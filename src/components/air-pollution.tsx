        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left space-y-2 flex-shrink-0">
            <div className="flex items-center justify-center md:justify-start gap-3">
              <div
                className={`flex items-center justify-center w-20 h-20 rounded-full border-4 border-current ${level.color} bg-background shadow-lg`}
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full">
            ...
            {renderPollutant("CO", current.components.co, "μg/m³", 15000)}{" "}
            {/* CO is high */}
          </div>
        </div>
